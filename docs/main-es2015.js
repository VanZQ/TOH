...
AppComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 14, vars: 1, consts: [["autoplay", "", "loop", "", "muted", ""], ["src", "\n  https://video.qiantucdn.com/58pic/37/43/09/64I58PICJBwIy9kh3gHHW.mp4_10s.mp4?e=1624350123&token=OyzEe_0O8H433pm7zVEjtnSy5dVdfpsIawO2nx3f:s7YsvBk4ESI5MvW8gKUOOVRUL44=", "type", "video/mp4"], ["routerLink", "/dashboard"], ["routerLink", "/heroes"], ["href", "https://vanzq.github.io/Website/Conclusion.HTML", "target", "_blank"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
HeroDetailComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: HeroDetailComponent, selectors: [["app-hero-detail"]], decls: 1, vars: 1, consts: [[4, "ngIf"], [1, "name"], ["for", "hero-name"], ["id", "hero-name", "placeholder", "Hero name", 3, "ngModel", "ngModelChange"], [3, "click"]], template: function HeroDetailComponent_Template(rf, ctx) { if (rf & 1) {
...
MessagesComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: MessagesComponent, selectors: [["app-messages"]], decls: 1, vars: 1, consts: [[4, "ngIf"], [1, "clear", 3, "click"], ["class", "message", 4, "ngFor", "ngForOf"], [1, "message"]], template: function MessagesComponent_Template(rf, ctx) { if (rf & 1) {
